      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-serif font-bold uppercase tracking-widest text-[#D4AF37]">
              Recognition & Achievement
            </span>
            <div className="w-3 h-3 bg-[#D4AF37] rounded-full animate-pulse" />
          </div>

          <h2 className="text-5xl sm:text-6xl lg:text-7xl font-serif font-black leading-tight mb-6 text-black">
            Awards & Recognition
          </h2>

          <p className="text-xl font-serif italic text-black/40 leading-relaxed max-w-3xl mx-auto">
            ...
            {awards.map((award, index) => (
              ...
              >
                ...
                <div className="relative mb-6">
                  ...
                  <div className={`relative p-6 rounded-2xl border shadow-md transition-all duration-500 hover:scale-105 ${index === 2 || index === 3 ? 'bg-gray-800 border-gray-700' : 'bg-background border-border'
                    }`}
                    style={{
